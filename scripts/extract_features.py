"""Extract frozen CLIP features for every image and caption of the vg_coco splits.

Output (format: docs/interfaces.md, section 2):
  data/features/vg_coco_image.npy   + .ids.json   (ids = image_id)
  data/features/vg_coco_caption.npy + .ids.json   (ids = caption_id)
...
Usage:  python scripts/extract_features.py
"""
import json
import sys
